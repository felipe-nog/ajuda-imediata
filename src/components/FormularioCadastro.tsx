...
export default function FormularioCadastro() {
  ...
  return (
    <div className="max-w-md mx-auto bg-white p-6 rounded-lg shadow-md border-t-4 border-blue-600">
      <h2 className="text-2xl font-bold mb-6 text-neutral-900">Como você pode participar?</h2>
      ...
      <form ref={formRef} action={handleSubmit} className="space-y-4">
        ...
        <div className="flex space-x-4 mb-4 bg-gray-50 p-3 rounded-md">
          <label className="flex items-center space-x-2 cursor-pointer">
            <input type="radio" name="tipo_publicacao" value="OFERTA" required className="text-blue-600 w-5 h-5" />
            <span className="font-medium text-gray-700">Quero Doar</span>
          </label>
          <label className="flex items-center space-x-2 cursor-pointer">
            <input type="radio" name="tipo_publicacao" value="PEDIDO" required className="text-orange-500 w-5 h-5" />
        ...
        <input type="text" name="bairro" placeholder="Seu Bairro (ex: Benfica, Cascatinha) *" required 
          className="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 outline-none" />

        {/* Dados do Item */}
        <label>Selecione o que precisa ou o que pretende doar:</label>
        <select name="categoria" required className="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 outline-none bg-white">
        ...
        <textarea name="descricao" rows={3} placeholder="Descreva os itens (ex: 2 fardos de água, preciso de um colchão de solteiro, etc.)" 
          className="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 outline-none resize-none"></textarea>
        ...
        <div className="bg-blue-50 p-3 rounded-md border border-blue-100">
          ...
          <p className="text-xs text-blue-600 mb-2">Você usará este código para remover o anúncio quando for resolvido.</p>
          <input 
            type="password" 
            name="pin_seguranca" 
            inputMode="numeric" 
