  ...
  return (
    <main className="min-h-screen bg-gray-100 p-4 md:p-8 font-sans">
      <div className="max-w-7xl mx-auto">
        ...
        <header className="flex flex-col lg:flex-row items-center gap-4 justify-center mb-8 bg-blue-900 text-white py-8 rounded-lg shadow-md">
          <Image
            src={"/ajuda.svg"}
            alt="Logo Ajuda Imediata"
            width={150}
            height={150}
          />
          <div className="flex flex-col text-center lg:text-start">
            <h1 className="text-3xl md:text-5xl font-extrabold mb-2 px-2">
              Ajuda Imediata Juiz de Fora
            </h1>
            <p className="text-blue-100 px-2">
              Uma iniciativa para auxiliar aqueles afetados pelas fortes chuvas de Fevereiro. <br />
